new Promise(function (resolve, reject) {
    ...
    var floor6 = $(".floor6")
    floor6.css("background","none");
    content(floor6, data)
    var content_right = $(".floor6>.tab_content>.tab_content_right");
    var ali = $(".floor6>.title>ul>li");
    var oImg = $(".floor6>.tab_content img");
    var iNow = 0;
    var Next = 0;
