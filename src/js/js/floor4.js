new Promise(function (resolve, reject) {
    ...
    var floor4 = $(".floor4")
    floor4.css("background","none");
    content(floor4, data)
    var content_right = $(".floor4>.tab_content>.tab_content_right");
    var ali = $(".floor4>.title>ul>li");
    var oImg = $(".floor4>.tab_content img");
    var iNow = 0;
    var Next = 0;
