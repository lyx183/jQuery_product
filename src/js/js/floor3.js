new Promise(function (resolve, reject) {
    ...
    var floor3 = $(".floor3")
    floor3.css("background","none");
    content(floor3, data)
    var content_right = $(".floor3>.tab_content>.tab_content_right");
    var ali = $(".floor3>.title>ul>li");
    var oImg = $(".floor3>.tab_content img");
    var iNow = 0;
    var Next = 0;
